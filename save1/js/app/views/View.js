// View.js
// -------
define(["jquery", "backbone", "underscore", "models/Profile", "text!templates/photoview.html", "text!templates/view.html", "text!templates/sidebar.html"],

    function($, Backbone, _, Profile, photoTemplate, template, sidebar){
        ...
        var View = Backbone.View.extend({
            ...
            initialize: function() {
				...
				/*
				for (var key in this.profilePictureModel) {
					if (this.profilePictureModel.hasOwnProperty(key)) {
						alert(key);
						alert(this.profilePictureModel.key);
						// useful code here
					}
				}
				*/
				/*
				this.collection = new Profile;
				_.bindAll(this, "render");
