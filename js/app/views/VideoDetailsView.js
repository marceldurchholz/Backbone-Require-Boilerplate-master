// VideoDetailsView.js
// -------
define(["jquery", "backbone", "models/videoModel", "collections/videosCollection", "text!templates/videoDetailsView.html", "text!templates/sidemenusList.html", "views/SidemenuView"],

    function($, Backbone, VideoModel, videosCollection, videosDetailsViewHTML, sidemenusList, SidemenuView){
							...
							function(tx) {
								...
								tx.executeSql(sql, 
									...
									function(tx, results) {
										...
										alert('found _thisViewVideoDetails.offlineurl ' + _thisViewVideoDetails.offlineurl);
